...
<div class="tadhy_t mian">
	<ul>
    	<li id='fensi'><a href="#" onmouseover="getFriendList(2,1,0,<%=length%>)" title="TA的粉丝">TA的粉丝</a></li>
        <li id='guanzhu'><a href="#" onmouseover="getFriendList(1,1,0,<%=length%>)" title="TA关注的人">TA关注的人</a></li>
    </ul>
