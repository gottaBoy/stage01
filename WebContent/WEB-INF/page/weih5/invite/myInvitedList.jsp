				...
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active">
				 		...
				 		<div class="inviteListItem">
				 			<div><span>邀请人:</span><a style="text-decoration:underline" href="artistDetail.htm?userId=<s:property value='#invite.inviteUserId'/>"><s:property value="#invite.inviteUserName" /></a></div>
