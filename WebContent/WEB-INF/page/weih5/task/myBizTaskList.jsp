			...
			<div class="warp swiper-container">
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active">
				 		...
				 		<s:iterator value="#request.userBizTaskList" var="item" status="st">
				 		<div class="list-x">
			 				<a href="myBizTaskDetail.htm?taskId=<s:property value="#item.id"/>">
			 					<h2><s:property value="#item.title" /></h2>
			 					<span style="width:45%;">活动人数：<s:property value="#item.personCount" /></span>
			 					<%-- <span class="tcenter">
			 						<s:property value="#item.creatTime" />
			 					</span> --%>
			 					<span style="width:45%;" class="tright"><s:property value="#item.creatTime" /></span>
			 				</a>
			 			</div>
				 		</s:iterator>
					</div>		
...
<a href="createH5BizTask.htm" class="newAdd" style="font-size:14px;bottom:60px;">新委托</a>
