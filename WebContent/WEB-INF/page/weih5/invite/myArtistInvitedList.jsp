			...
			<div class="warp swiper-container">
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active">
				 		<s:iterator value="#request.invitedList" var="invite" status="st">
				 		<div class="inviteListItem">
				 			<div><span>艺人:</span><a href="artistDetail.htm?userId=<s:property value='#invite.artistId'/>"><s:property value="#invite.artistName" /> <font style="color:blue;font-size:12px;">(详情)</font></a></div>
				 			<div><span>邀请人:</span><a href="artistDetail.htm?userId=<s:property value='#invite.inviteUserId'/>"><s:property value="#invite.inviteUserName" /> <font style="color:blue;font-size:12px;">(详情)</font></a></div>
