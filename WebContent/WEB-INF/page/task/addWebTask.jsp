...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="width: 520px;height: 560px">
	<form id="userTaskForm" method="post" action="<%=request.getContextPath() %>/member/task!addUserTask.htm" >
    ...
    <tr>
		...
		<td  style="padding-right: 20px"><font color=red>*</font>任务总预算
			 <input type="text" name="task.price" id="price" class="add_popup_input" style="width:50px;vertical-align: middle"/>&nbsp;&nbsp;元 </td>
    </tr>
    ...
    <tr>
        ...
        <td ><table width="220" border="0" align="center" cellpadding="0" cellspacing="0" class="add_popup_button">
            <tr>
                <td align="center"><a href="javascript:addUserTask();">
