...
<!-- <li><a  class="change" href="orginfo.htm?sign=4&<%=HttpSessionHelper.getParamData(request)%>">绑定支付宝</a></li> -->
...
<li>
    <a href="javascript:updateAlipay1()" class="querenbaocun2">确认保存</a>
</li>
</ul>
</div>
</div>
     ...
     <div id="input_2" style="display: none;">
        <div class="zhifu">
			...
			<li>
				 <a href="javascript:updateAlipay()"class="querenbaocun2">我要提交</a>
				 <a href="javascript:updateAlipay2()"class="querenbaocun2">我要取消</a>
			</li>
			</ul>
			</div>
			</div>   
