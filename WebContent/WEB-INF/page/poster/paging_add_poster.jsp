...
<input type="hidden" name="type" id="type"  value="${type}"/>
	 	<input type="file" id="purl" name="purl" style="width: 500px;" onchange="readURL(this)"/>
		<img style="margin-top: 20px;display: none" id="showImg" name="showImg" src="" alt="" width="960" height="380"/><br/>
		...
		<div style="margin-top: 20px"><textarea name="info.content" id="info.content" cols="120" rows="5" style="width:700px;height:350px;visibility:hidden;"></textarea></div>
...
<!-- <form id="infoForm" name="infoForm" action="member/poster!doAdd.htm" method="post" enctype="multipart/form-data"> -->
<%-- <input type="hidden" name="type" id="type"  value="${type}"/> --%>
<!-- <table width="100%" border="0" style="line-height: 20px" cellpadding="0" cellspacing="0"> -->
<!--   <tr> -->
<!--     <td width="45%" ><img id="showImg" name="showImg" style="display: none;"/></td> -->
<!--     <td width="1%" >&nbsp;</td> -->
<%--      <td width="54%"  valign="top"><input id="purl" name="purl" type="file" onchange="readURL(this)></td> --%>
<!--   </tr> -->
<!--   <tr> -->
<!--     <td height="37">地址： -->
<!--       <input class="input_xl" type="text" name="info.plink" id="info.plink" style=" width:480px; "></td> -->
<!--     <td>&nbsp;</td> -->
<!--  <td >&nbsp;</td> -->
<!--   </tr> -->
<!--   <tr> -->
<!--     <td height="37">标题： -->
<!--       <input class="input_xl" type="text" name="info.title" id="info.title" style=" width:480px; "></td> -->
<!--     <td>&nbsp;</td> -->
<!--  <td >&nbsp;</td> -->
<!--   </tr> -->
<!--   <tr> -->
<!--   	<td > -->
<!--   		<textarea name="info.content" id="info.content" cols="120" rows="5" style="width:700px;height:350px;visibility:hidden;margin-top: 20px"></textarea> -->
<!--   	</td> -->
<!--   </tr> -->
<!--   <tr> -->
<!--   <td align="center"> -->
