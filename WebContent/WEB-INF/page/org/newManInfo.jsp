...
var checkedIndex = 0;
	...
	art.dialog.open('<%=request.getContextPath() %>/member/evaluate!image2.htm?id='+userId,{width:600,height:500,resize: false});
}
...
function doAddorUpdate(userId,flag){
	$.ajax({
		   url:"<%=request.getContextPath() %>/member/newManInfo!saveNewMan.htm?userId="+userId+"&flag="+flag,
		   type:'POST',
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="layout_table">
    <tr>
        ...
        <s:action name="menuHyzx" executeResult="true">
        	<s:param name="menuFlag" value="29"></s:param>
        </s:action>
       <!-- 会员 左导航 结束 -->
</td>
        <td height="720">&nbsp;</td>
        <td width="810" align="left" valign="top">
        <div class="your_position">您的位置：<a href="#">首页</a> > <a href="#">新人推荐</a></div>


<span class="clear"></span>
<form name="searchForm1" id="searchForm1" method="post" action='newManInfo.htm'>
	<table>
		<tr>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="page">
    <tr>
        <td align="center"><pg:pages  pageNo='${pageNum}' rowCount ="10"  url="newManInfo.htm" params='keywords=${pageKeywords}'  total='${game}' ></pg:pages></td>
    </tr>
</table>
