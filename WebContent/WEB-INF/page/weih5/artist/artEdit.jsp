				...
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active artist">
				 		<ul class="list">
				 			...
				 			<%-- <li><div class="inp1"><label>手机：</label><input type="text"
				 				value="<s:property value='#request.editUserInfo.mobile'/>" readonly="readonly" class="artname ctel"> *</div></li>
				 			<li><div class="inp1"><label>Email：</label><input type="text"
				 				value="<s:property value="#request.editUser.email"/>" readonly="readonly" class="artname cmail"> *</div></li> --%>
				 			<li><div class="inp1"><label>身高：</label><input type="text" class="artname cheight" value="<s:property value='#request.editUserInfo.height'/>"> cm</div></li>
				 			<li><div class="inp1"><label>体重：</label><input type="text" class="artname cweight" value="<s:property value='#request.editUserInfo.weight'/>"> kg</div></li>
				 			<li><div class="inp1"><label>胸围：</label><input type="text" class="artname cbust" value="<s:property value='#request.editUserInfo.heartSize'/>"> cm</div></li>
				 			<li><div class="inp1"><label>腰围：</label><input type="text" class="artname cwaist" value="<s:property value='#request.editUserInfo.waistSize'/>"> cm</div></li>
				 			<li><div class="inp1"><label>臀围：</label><input type="text" class="artname chipline" value="<s:property value='#request.editUserInfo.bottocksSize'/>"> cm</div></li>
				 			<li class="bbn"><div class="inp1"><label class="lab-intro">个人介绍：</label><textarea cols='7' class="tea-intro cintro"><s:property value='#request.editUserInfo.introduction'/></textarea></div></li>
				 		</ul>
