...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function toCheck(id){
		art.dialog({
		        icon: 'succeed',
				content: "当前用户申请成为专业会员，您确定审核通过吗？",
				ok: function () {
				   $.post('<%=request.getContextPath()%>/member/userinfo!applicateFinish.htm?id='+id,
						function(data){
							if(data=="1"){
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="layout_table">
    <tr>
        ...
        <s:action name="menuHyzx" executeResult="true">
        	<s:param name="menuFlag" value="100"></s:param>
        </s:action>
       <!-- 会员 左导航 结束 -->
</td>
        <td height="720">&nbsp;</td>
        <td width="810" align="left" valign="top">
        <div class="your_position">您的位置：<a href="#">首页</a> > <a href="#">观众用户申请</a></div>
		

<span class="clear"></span>
<form name="searchForm" id="searchForm" method="post" action='userinfo!getNorUserForManager.htm'>
	...
	<s:iterator value="#request.userInfoList" var="item" status="st">
		<tr>
	        ...
	        <td  align="center"  >
        	    ...
        	    <s:if test="#item[0].applicate==1">
		      		<a href="javascript:toCheck('<s:property value="#item[0].id"/>');" class="czjl_title_link">审核通过</a>	        
		        </s:if>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="page">
    <tr>
        <td align="center"><pg:pages  pageNo='${pageNum}' rowCount ="10"  url="userinfo!getNorUserForManager.htm" params='keywords=${keywords}&flag=1'  total='${game}' ></pg:pages></td>
    </tr>
</table>
