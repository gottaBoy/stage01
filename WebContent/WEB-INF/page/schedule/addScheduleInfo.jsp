...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		function addScheduleInfo(){
			...
			$.post('<%=request.getContextPath()%>/member/scheduleInfo!checkStartDate.htm?userId=<s:property value="#request.userId"/>&startDate='+startDateTime+'&endDate='+endDateTime,
				function(data){
					...
					if(data == "1"){
						...
						if(checknull()){
							$.ajax({
							   url:"<%=request.getContextPath() %>/member/scheduleInfo!addScheduleInfo.htm?userId=<s:property value='#request.userId'/>",
							   type:'POST',
  ...
  <body style="width: 520px;height: 370px">
	<form id="scheduleInfoForm" method="post" action="<%=request.getContextPath() %>/member/scheduleInfo!addScheduleInfo.htm?userId=<s:property value="#request.userId"/>" >
    ...
    <tr>
        ...
        <td width="162"><input type="text" name="scheduleInfo.title" id="title" class="add_popup_input" /></td>
        <td width="58" align="right">地点 </td>
        <td width="179"><input type="text" name="scheduleInfo.address" id="address" class="add_popup_input" /></td>
    </tr>
    <tr>
        ...
        <td><table width="158" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
			   ...
			   %>
                    <option value="<%=timestr%>" <%=timestr.equals("")?"selected":""%>> 
                      <%=timestr%>
                    </option>
                 <%
					}
    ...
    <tr>
        ...
        <td colspan="3"><textarea name="scheduleInfo.content" id="content" cols="45" rows="5" class="add_popup_textarea "></textarea></td>
        </tr>
    </table>
    ...
    <tr>
        ...
        <td ><table width="220" border="0" align="center" cellpadding="0" cellspacing="0" class="add_popup_button">
            <tr>
                <td align="center"><a href="javascript:addScheduleInfo();">
