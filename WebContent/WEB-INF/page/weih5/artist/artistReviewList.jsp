		...
		<form action="#" method="post" id="form1">
			<div class="warp swiper-container">
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active art-detail">
						<div class="transaction">
							<h3 class="trans-h3"><em></em> 交易评价</h3>

							<ul>
							
							<s:if test="#request.reviewList==null || #request.reviewList.size()==0">
								<div style="margin-top:20px;">没有找到评价信息.</div>
							</s:if>
							<s:else>
								<s:iterator value="#request.reviewList" var="evaluate">
									<li>
										<div class="trans-nav"><span><s:property value="#evaluate[2]"/></span><span><s:property value="#evaluate[0].CreatTime"/></span></div>
										<div class="trans-txt">
											<s:property value="#evaluate[0].pjContent"/>
										</div>
									</li>
								</s:iterator>
							</s:else>
