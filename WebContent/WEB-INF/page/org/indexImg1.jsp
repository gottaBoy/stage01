...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function handleImgLoadError(oEvent)
			...
			var flashvars = {
			  "uploadServerUrl":"./newManInfo!upLoadPic.htm?userId="+'${userId}'+""
			};
			var params = {
				wmode:"opaque",
				width:800,
			...
			var attributes = {
				...
				swfobject.embedSWF("../theme/flex/newMan.swf", "altContent", "600", "500", "9.0.0", "expressInstall.swf", flashvars, params, attributes);
			...
			function avatar_success()
			{
				...
				window.parent.document.getElementById("pic_"+'${userId}').style.display = "";
				art.dialog.close(); 
			}
