	...
	<script type="text/javascript" language="javascript" src="<%=request.getContextPath() %>/01stageDialog/plugins/iframeTools.js"></script>
         ...
         <div class="product">
          ...
          <div class="product_wrap posSix"> 
            ...
            <li><a href="/" >首页</a></li>
            <li><a href="<%=path %>/index/indexAction!toNovice.htm" >新手上路</a></li>
            <li><a href="<%=path %>/index/indexAction!toOrg.htm" >机构</a></li>
            <li><a href="<%=path %>/index/indexAction!toJobChance.htm" >工作机会</a></li>
      	</ul>
      </div>
