...
<%-- 		art.dialog.open('<%=request.getContextPath()%>/member/information!toInfo.htm',{width:750,height:600,resize: false}); --%>
	...
	function toDel(id){
		window.location.href = "<%=request.getContextPath()%>/member/poster!edit.htm?pid="+id+"&type=${type}";
	}
</script>		
</head>
  <body>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="zyfl_table">
		<tr>
		    ...
		    <td  width="center" class="zyfl_title">发布时间</td>     
	...
	<s:iterator value="#request.infoList" var="info">
		<tr>
	        ...
	        <td  align="center"  ><s:property escape="false" value="#info.content.trim()"/>&nbsp;</td>
	        <td  align="center"><s:property value="#info.pString"/>&nbsp;</td>
