...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function toPayPage(id) {
		window.open("<%=request.getContextPath()%>/member/business!getPayInfo.htm?id="+id);
  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="layout_table">
    <tr>
        ...
        <s:action name="menuHyzx" executeResult="true">
        	<s:param name="menuFlag" value="26"></s:param>
        </s:action>
       <!-- 会员 左导航 结束 -->
</td>
        <td height="720">&nbsp;</td>
...
<li><a class="change" href="#" id="font3">待付款订单</a></li>
</ul>
</div>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="zyfl_table">
    <tr>
        ...
        <td width="130" align="center" class="zyfl_title">签约者</td>
        <td width="130" align="center" class="zyfl_title">被签约者</td>
        <td width="100" align="center" class="zyfl_title">付款金额</td>
        <td width="80" align="center" class="zyfl_title">状态</td>
        <td width="120" align="center" class="zyfl_title">操作</td>
    </tr>
     <s:iterator value="#request.payList" var="businessInfo">
    <tr>
    	<td align="center"><a href="javaScript: toBusinessView(<s:property value="#businessInfo[0].id"/>);" class="czjl_title_link"><s:property value="#businessInfo[0].orderCode"/></a></td>
        <td align="left"><a href="javaScript: userView(<s:property value="#businessInfo[0].buyer"/>);" class="czjl_title_link"><s:property value="#businessInfo[2]"/></a></td>
        <td align="left"><a href="javaScript: userView(<s:property value="#businessInfo[0].seller"/>);" class="czjl_title_link"><s:property value="#businessInfo[3]"/></a></td>
        
        
        <td align="right">￥<fmt:formatNumber pattern="0.00"><s:property value="#businessInfo[5]"/></fmt:formatNumber></td>
        <td align="center">
        	<span>等待付款</span>
        </td>
        <td align="center">
        	
        	<a href="javaScript:toPayPage(<s:property value="#businessInfo[0].id"/>);" class="czjl_title_link">付款</a>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="page">
    <tr>
        <td align="center"><pg:pages  pageNo='${pageNum}' rowCount ="10"  url="business!payList.htm" total='${totalPage}' ></pg:pages></td>
    </tr>
</table>
</td>
    </tr>
