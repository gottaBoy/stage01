<%@page import="com.smt.common.VideoUtil"%>
...
<table width="750" border="0" cellspacing="0" cellpadding="0" id="list_photo_img" >
    <tr>
        <td>
<div class="list_contitle"><ul>
<li><span class="list_contitle_01"><a style="color: #333" href="presonList.htm?id=<s:property value="#request.id"/>">首页</a> > 视频</span></li></ul></div>
...
<div class="clear"></div>
<div class="list_content_page" style="margin-top:20px;margin-bottom: 30px;"><pg:pages  pageNo='${pageNum}' rowCount ="10"  url="presonList!userPhoto.htm" params="id=${id }&&sign=2"  total='${total}' ></pg:pages></div>
</td>
</tr>
</table>
