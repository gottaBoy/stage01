...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function handleImgLoadError(oEvent)
			...
			var flashvars = {
			  "uploadServerUrl":"./activeStarInfo!upLoadPic.htm?userId="+'${userId}'+""
			};
			var params = {
				wmode:"opaque",
				width:800,
				height:600,
				miniSize :"200",	 //上传图片的宽度
				type:"application/x-shockwave-flash"	
			};
			var attributes = {
			};
			
				swfobject.embedSWF("../theme/flex/activeStarInfo.swf", "altContent", "600", "500", "9.0.0", "expressInstall.swf", flashvars, params, attributes);
