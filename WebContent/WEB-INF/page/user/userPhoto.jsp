...
<li><span class="list_contitle_01"><a style="color: #333" href="presonList.htm?id=<s:property value="#request.id"/>">首页</a> > 相册</span></li></ul></div>
...
<li>
<a href="presonList!imageView.htm?id=<s:property value="#request.id"/>&&pic=<s:property value="#item.id" />"><img onerror="handleImgLoadError(event);"  src="<s:property value="#item.url" />" width="135" height="135" /></a>
<p><a href="presonList!imageView.htm?id=<s:property value="#request.id"/>&&pic=<s:property value="#item.id" />"><s:property value="#item.title" /></a><br><span><s:property value="#item.creatTime.substring(0,10)" /></span><s:property value="#item.imgCount" />张</p></li>
</s:iterator>
