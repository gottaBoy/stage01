...
<div style="margin-top: 20px"><textarea name="info.purl" id="infopurl" cols="120" rows="5" style="width:700px;height:350px;visibility:hidden;">${info.purl}</textarea></div>
		...
		<div style="margin-top: 20px"><textarea name="info.content" id="infocontent" cols="120" rows="5" style="width:700px;height:350px;visibility:hidden;">${info.content}</textarea></div>
