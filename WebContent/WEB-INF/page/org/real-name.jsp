...
<li><a  class="change"  href="userinfo.htm?sign=4">实名认证</a></li>
...
<form id="realNameForm" name="realNameForm" action="userinfo!saveRealName.htm" method="post" enctype="multipart/form-data">
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="rznr_box">
    <tr>
        <td colspan="2" align="left">上传证件照片<span>(必传)</span></td>
    ...
    <tr>
        <td colspan="2" align="left">证件号码<span>(必填且必须与提交的证件照片号码一致)</span></td>
        </tr>
    <tr>
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="rz_smtext">
    ...
    <tr>
        <td><img src="<%=request.getContextPath() %>/theme/images/small_star.jpg" width="10" height="10" />&nbsp;（身份证/护照/军官证均可）用相机拍下来，照片清晰无遮挡。</td>
    </tr>
    <tr>
        <td><img src="<%=request.getContextPath() %>/theme/images/small_star.jpg" width="10" height="10" />&nbsp;您的证件仅在审核人员审核时可以看见，第1舞台严格保护您的隐私，请放心。</td>
    </tr>
    <tr>
        <td><img src="<%=request.getContextPath() %>/theme/images/small_star.jpg" width="10" height="10" />&nbsp;身份证相片必须与个人相片吻合，否则视无效申请！</td>
    </tr>
</table>
</s:if>
<s:if test="#request.user.rzState==3">
