    ...
    <tr>
        ...
        <table width="680" border="0" align="center" cellpadding="0" cellspacing="1" class="add__gly" bgcolor="#CCCCCC">
            <tr>
                ...
                <td width="400" align="right" bgcolor="#FFFFFF">昵称：</td>
                <td colspan="3"  bgcolor="#FFFFFF" class="text_cor">${userInfo.nickName }</td>
                <td width="66" align="right" bgcolor="#FFFFFF">性别：</td>
                <td width="110" bgcolor="#FFFFFF" class="text_cor">
            ...
            <tr>
                ...
                <td colspan="3" bgcolor="#FFFFFF" class="text_cor">${userInfo.weight }</td>
                </tr>
            ...
            <tr>
                ...
                <td  bgcolor="#FFFFFF" class="text_cor">${userInfo.major }</td>
                <td align="right" bgcolor="#FFFFFF">毕业院校：</td>
                <td colspan="3" bgcolor="#FFFFFF" class="text_cor">${userInfo.school }</td>
