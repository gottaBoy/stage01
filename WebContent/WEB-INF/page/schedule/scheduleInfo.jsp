 ...
 function NowMonth() {
  ...
  //下一年
   ...
   function toAddSchedule(){
  		art.dialog.open('<%=request.getContextPath() %>/member/scheduleInfo!toAddScheduleInfo.htm',{resize: false});
   }

	function toUpdateSchedule(id){
	  	art.dialog.open('<%=request.getContextPath() %>/member/scheduleInfo!toUpdateScheduleInfo.htm?id='+id,{resize: false});
   }
    ...
    <tr>
       ...
       <!-- 会员 左导航 开始 
        ...
        <s:action name="menuHyzx" executeResult="true">
        	<s:param name="menuFlag" value="4"></s:param>
        </s:action>
       <!-- 会员 左导航 结束 -->
</td>
        <td height="720">&nbsp;</td>
...
">您的位置：<a href="#" >首页</a> > <a href="#">档期管理</a></div>
