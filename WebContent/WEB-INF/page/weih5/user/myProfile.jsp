			...
			<div class="mui-scroll no-ab">
				<ul class="mui-table-view mui-table-view-chevron">
					...
					<li class="mui-table-view-cell center_list">
						<a href="createH5BizTask.htm" class="center_item" style="width: 49%">
                        ...
                        <a href="createH5Task.htm" class="center_item" style="border-left: 1px solid #eee; width: 49%">
                            <!-- <img class="icon" src="/stage01/h5assets/images/person_2.png"> -->
                            <img class="icon" src="/h5assets/images/person_2.png">
                            <div>发布通告</div>
                        </a> 
				...
				<ul class="mui-table-view mui-table-view-chevron">
					...
					<li class="mui-table-view-cell">
						<a href="myAppliedTaskList.htm" class="mui-navigate-right">我应征的通告(<s:property value="#request.profileInfoVo.myAppliedTaskCount"/>)</a>
					</li>
				</ul>
				<ul class="mui-table-view mui-table-view-chevron">
					<li class="mui-table-view-cell">
					...
					<li class="mui-table-view-cell">
						<a href="myInvitedList.htm" class="mui-navigate-right">我收到的邀请(<s:property value="#request.profileInfoVo.invitedMeCount"/>)</a>
					</li>
				</ul>
				<ul class="mui-table-view mui-table-view-chevron">
					<li class="mui-table-view-cell">
