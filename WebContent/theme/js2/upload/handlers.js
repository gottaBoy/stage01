...
function addReadyFileInfo(fileid,fileName,message,status){
	...
	$("#divFileProgressContainer").css("paddingTop", "0px");
	//用表格显示
	...
	var html = "<div style='display:block; float:left; white-space:nowrap; text-overflow:ellipsis; overflow: hidden;width:270px;' title='"+fileName+"'>"+fileName+"</div>";
	col2.innerHTML = html;
	...
	col2.style.width="280";
	col2.align="left";
	//col3.style.width="20";
	//col4.style.width="30";
	parent.setSize(350, $("#content").height() + 50);
...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		document.getElementById(targetID).style.paddingTop = "10px";
