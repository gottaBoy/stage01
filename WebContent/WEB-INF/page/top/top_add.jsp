...
<%-- 		    'data':'<%=request.getContextPath()%>/member/top!doUserIndex.htm', --%>
// 		    'ajaxType':'post',
// 		    'listStyle': 'custom',
// 		    'width':180,
// 		    'ajaxDataType':'json',
...
// 		    	return "<span style='color:green;'>"+data["nickname"]+"</span>";
// 		    },
...
// 		});
	...
	var afterMethod = function (){
		//var id = $("#wordsId-1").val();
		//var name = $("#lessonId").val();
// 		openTextInfo($("#lessonId-1").val(),$("#lessonParentId-1").val());
		//alert($("#lessonId-1").val()+" "+$("#lessonParentId-1").val());
	}
...
<form id="infoForm" name="infoForm" action="member/top!doAddTop.htm" method="post" enctype="multipart/form-data">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" height="58"><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>&nbsp;名称
        <input class="input_xl" type="text" name="vo.name" id="vo.name"  style="width:300px; height:25px ;">     </td>
  ...
  <tr>
    <td><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>&nbsp;昵称/艺名
        <input class="input_xl" type="text" value="${vo.userid.name}" name="username" id="username" style="width:300px; height:25px ;">
        <input type="hidden" id="info.userId" name="info.userId" value="${vo.userid.userId}"/>
    </td>
    <td height="100"><textarea name="vo.comment" id="vo.comment" style="width:300px; height:80px; "></textarea></td>
  </tr>
  <tr>
    <td height="20"><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>第一图片</td>
    <td><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>第二图片</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="320" class="b"><img src="<%=request.getContextPath() %>/theme/images2/error_h.jpg" width="236" height="312" name="showImg1" id="showImg1"/></td>
    <td><img src="<%=request.getContextPath() %>/theme/images2/error_h.jpg" width="236" height="312" id="showImg2"/></td>
  </tr>
  <tr>
    <td height="39"><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>&nbsp;图片描述 
      <input class="input_xl" type="text" name="imgs1.tmemo" id="imgs1.tmemo" style="width:300px; height:25px ;">  </td>
    <td><img src="<%=request.getContextPath() %>/theme/images2/circle.png"/>&nbsp;图片描述 
      <input class="input_xl" type="text" name="imgs2.tmemo" id="imgs2.tmemo" style="width:300px; height:25px ;">  </td>
  </tr>
  <tr>
    <td height="35" class="b">链&nbsp;&nbsp;接：
      <input class="input_xl" type="text" name="imgs1.tlink" id="imgs1.tlink" style="width:300px; height:25px ;"></td>
    <td class="b">链&nbsp;&nbsp;接：
      <input class="input_xl" type="text" name="imgs2.tlink" id="imgs2.tlink" style="width:300px; height:25px ;"></td>
  </tr>
  <tr>
    <td height="41">&nbsp;</td>
