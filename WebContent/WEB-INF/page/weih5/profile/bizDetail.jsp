						...
						<div class="art-head">
				 		...
				 		<ul class="list">
				 			<s:if test="#request.userInfo.introduction == null || #request.userInfo.introduction == ''">
				 				<li><span>公司简介</span><em class="intro">暂无</em></li>
				 			</s:if>
				 			<s:else>
				 				<li><span>公司简介</span><em class="intro"><s:property value="#request.userInfo.introduction"/></em></li>
				 			</s:else>
				
				 			<li><span>服务内容</span><em class="intro"><s:property value="#request.userInfo.companyTags"/></em></li>
							<li>
								<span>所在地</span><em><s:property value="#request.userInfo.provice"/> &nbsp;<s:if test="#request.userInfo.city != null && #request.userInfo.city != ''">|&nbsp; <s:property value="#request.userInfo.city"/>
								</s:if><s:if test="#request.userInfo.place != null && #request.userInfo.place != ''">|&nbsp; <s:property value="#request.userInfo.place"/>
								</s:if></em>
							</li>
				 			<%-- <li><span>服务内容</span><em class="intro"><s:property value="#request.userInfo.seviceScope"/></em></li> --%>
				 				...
				 				<li class="mui-table-view-cell mui-media">
									<a class="mui-navigate-right" href="artistDetail.htm?userId=<s:property value="#art.userId"/>">
										...
										<div class="mui-media-body">
											<s:property value="#art.nickName"/>
											<p class='mui-ellipsis'><s:property value="#art.tags"/></p>
										</div>
									</a>
								</li>
						 		</s:iterator>
