...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		KindEditor.ready(function(K) {
    	   ...
    	   var dataId =document.getElementById("info.id").value;  
    	   if(dataId!=''){
    	   		document.getElementById("info.parentId").value=${info.parentId };
    	   }
  ...
  <body>
    ...
    <input type="hidden" name="info.status" value="${info.status }"/> 
...
<textarea name="info.content" id="info.content" cols="80" rows="5" style="width:700px;height:350px;visibility:hidden;"><%=StageVariale.htmlspecialchars(htmlData)%></textarea>
		        </td>
