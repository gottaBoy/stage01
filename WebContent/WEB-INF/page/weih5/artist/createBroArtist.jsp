				...
				<div class="issue swiper-wrapper " id="issue">
					<div class="cnt swiper-slide swiper-slide-visible swiper-slide-active artist">
				 		<ul class="list">
				 			...
				 			<li><div class="inp1"><label>性别：</label><div class="in"><button id='showUserPicker' class="mui-btn mui-btn-block csex btn-black" type='button'>男</button></div> <font style="color:orange">*</font></div></li>
				 			<li><div class="inp1"><label>出生年月：</label> <div class="in relative"><!-- <input type="date" class="time-x">
						 			...
						 			<button id='demo1' data-options='{"type":"date","beginYear":1920,"endYear":2020}' class="btn mui-btn mui-btn-block cbrith btn-black">2015-01-01</button>
						 		</div> 
			 				<font style="color:orange">*</font></div></li>
			 				<li><div class="inp1"><label>所在地：</label> <div class="in"><button id='showCityPicker' class="mui-btn mui-btn-block caddress btn-black" type='button'>上海市</button> </div></div></li>
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (result == "error") {
					...
					$("#create-art-commit").click(stepRegCommit);
