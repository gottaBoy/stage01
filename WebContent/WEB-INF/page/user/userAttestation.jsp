...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function toCheckAll(){
	  ...
	  if(idls=="") {art.dialog.tips("请您选择需要认证的用户！");}
	  else
	  {
	  		art.dialog({
		        icon: 'succeed',
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="layout_table">
    <tr>
        ...
        <s:action name="menuHyzx" executeResult="true">
        	<s:param name="menuFlag" value="9"></s:param>
        </s:action>
       <!-- 会员 左导航 结束 -->
</td>
        <td height="720">&nbsp;</td>
        <td width="810" align="left" valign="top">
        <div class="your_position">您的位置：<a href="#">首页</a> > <a href="#">用户认证</a></div>


<span class="clear"></span>
<form name="searchForm" id="searchForm" method="post" action='userinfo!getUserForAttestation.htm'>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="zyfl_table">
		<tr>
		    ...
		    <td   align="center" class="zyfl_title">身份证号码</td>
...
<table width="790" border="0" align="center" cellpadding="0" cellspacing="0" class="page">
    <tr>
        <td align="center"><pg:pages  pageNo='${pageNum}' rowCount ="10"  url="userinfo!getUserForAttestation.htm" params='keywords=${keywords}&flag=1'  total='${total}' ></pg:pages></td>
    </tr>
</table>
